        ...
        <>
            <div className="flex items-center justify-center flex-col">
                ...
                <div className='justify-center h-full w-full py-1 px-10 relative overflow-x-hidden'>
                    <div>
                        <img alt="workout images" className='ml-auto mr-auto rounded-2xl bg-cover duration-500 drop-shadow-2xl m-0' src={slides[currentIndex].url} />
                    </div>
                    ...
                    <div className='flex-col text-center mr-auto ml-auto mb-5'>
